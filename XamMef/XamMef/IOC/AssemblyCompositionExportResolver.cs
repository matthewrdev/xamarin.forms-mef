...
namespace MFractor.IOC
{
    ...
    public abstract class AssemblyCompositionExportResolver : BaseExportResolver
    {
        ...
        public override void Prepare()
        {
            ...
            ExternalPartsCatalog = new ExternalPartComponentCatalog();
            RegisterExternalParts(ExternalPartsCatalog);

            Catalog.Catalogs.Add(ExternalPartsCatalog);
        ...
        public ExternalPartComponentCatalog ExternalPartsCatalog { get; private set; }
